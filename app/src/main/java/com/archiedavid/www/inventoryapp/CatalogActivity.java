...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertProduct() {
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_NAME, "Apple Macbook Pro");
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_QUANTITY, 1);
        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, 7);

        // Insert a new row for Apple Macbook Pro into the provider using the ContentResolver.
        // Use the {@link ProductEntry#CONTENT_URI} to indicate that we want to insert
        // into the product database table.
        // Receive the new content URI that will allow us to access Apple Macbook Pro's data in the future.
